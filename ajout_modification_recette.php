...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3 p-5">
        ...
        <textarea name="description" id="description" cols="30" rows="5" class="form-control" value="<?= $recipe['desciption']; ?>"></textarea>
    </div>
    <div class="mb-3 p-5">
        <label for="ingredients" class="form-label">Ingrédients</label>
        <textarea name="ingredients" id="ingredients" cols="30" rows="5" class="form-control" value="<?= $recipe['ingredients']; ?>"></textarea>
    </div>
    <div class="mb-3 p-5">
        <label for="instructions" class="form-label">Instructions</label>
        <textarea name="instructions" id="instructions" cols="30" rows="5" class="form-control" value="<?= $recipe['instructions']; ?>"></textarea>
    </div>
    <div class="mb-3 p-5">
